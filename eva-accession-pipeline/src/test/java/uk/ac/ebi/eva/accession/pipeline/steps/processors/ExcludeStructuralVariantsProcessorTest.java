...
public class ExcludeStructuralVariantsProcessorTest {
    ...
    private static final String ALT_WITH_SINGLE_BASE = "A";

    private static final String ALT_WITH_MULTI_BASE = "AT";

    private static final String ALT_WITH_EMPTY_ALLELE = "";

    private static final String[] ALTS_WITH_SYMBOLIC_INDEL = new String[]{"<DEL>", "<INS>", "<DUP>", "<INV>", "<CNV>"
            , "<DUP:TANDEM>", "<DEL:ME:C1#>", "<INS:ME:C1#>"};

    private static final String ALT_WITH_SYMBOLIC_ALLELE = "<ID>";
     ...
     */
    private static final String[] ALTS_WITH_BREAK_END_NOTATION = new String[]{
            "G]2:421681]", "]2:421681]G", "]<contig1#>:1234]ATG",
            "G[2:421681[", "[2:421681[G", "[<contig1#>:1234[ATG",
            ".AGT", "AGT."};

    private static final String ALT_GVCF_NOTATION_FOR_REF_ONLY_RECORDS = "<*>";
    ...
    public void altWithMultiBaseAllele() {
        IVariant variant = newVariant(ALT_WITH_MULTI_BASE);
        assertEquals(variant, processor.process(variant));
    }
    ...
    public void altWithSymbolicAllele() {
        IVariant variant = newVariant(ALT_WITH_SYMBOLIC_ALLELE);
    ...
    public void altWithGVCFAsteriskNotation() {
        IVariant variant = newVariant(ALT_GVCF_NOTATION_FOR_REF_ONLY_RECORDS);
        assertNull(processor.process(variant));
    }
}
