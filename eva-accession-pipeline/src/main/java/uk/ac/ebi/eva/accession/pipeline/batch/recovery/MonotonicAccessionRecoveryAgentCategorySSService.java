...
public class MonotonicAccessionRecoveryAgentCategorySSService {
    ...
    public MonotonicAccessionRecoveryAgentCategorySSService(MonotonicAccessionRecoveryAgent monotonicAccessionRecoveryAgent,
