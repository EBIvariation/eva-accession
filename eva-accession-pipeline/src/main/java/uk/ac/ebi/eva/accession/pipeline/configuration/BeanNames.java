...
public class BeanNames {
    ...
    public static final String SS_ACCESSION_RECOVERY_SERVICE = "SS_ACCESSION_RECOVERY_SERVICE";

    public static final String SS_ACCESSION_RECOVERY_STEP = "SS_ACCESSION_RECOVERY_STEP";
