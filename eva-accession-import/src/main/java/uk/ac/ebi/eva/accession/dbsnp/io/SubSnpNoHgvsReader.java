...
public class SubSnpNoHgvsReader extends JdbcCursorItemReader<SubSnpNoHgvs> {
    ...
    public SubSnpNoHgvsReader(String assembly, Integer buildNumber, DataSource dataSource, int pageSize) throws Exception {
    ...
    private String buildSql(String assembly, Integer buildNumber) {
    ...
    private String getTableName(String assembly, Integer buildNumber) {
        if (buildNumber == null) {
