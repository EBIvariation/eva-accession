...
import uk.ac.ebi.eva.accession.release.configuration.batch.jobs.CreateIncrementalReleaseJobConfiguration;
...
@Import({MongoConfiguration.class,
         ...
         CreateIncrementalReleaseJobConfiguration.class,
...
public class IncrementalReleaseTestConfiguration {
