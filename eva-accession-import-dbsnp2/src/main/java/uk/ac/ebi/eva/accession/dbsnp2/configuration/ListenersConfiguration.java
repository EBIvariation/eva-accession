...
public class ListenersConfiguration {
    ...
    @Bean(name = IMPORT_DBSNP_JSON_VARIANTS_PROGRESS_LISTENER)
    @StepScope
    public ImportDbsnpJsonVariantsStepProgressListener stepProgressListener(InputParameters parameters,
                                                                            ImportCounts importCounts) {
        return new ImportDbsnpJsonVariantsStepProgressListener(parameters.getChunkSize(), importCounts);
    }
