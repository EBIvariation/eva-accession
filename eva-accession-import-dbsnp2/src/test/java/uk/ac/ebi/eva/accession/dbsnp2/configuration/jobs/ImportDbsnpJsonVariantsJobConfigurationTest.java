 ...
 */
package uk.ac.ebi.eva.accession.dbsnp2.configuration.jobs;
...
public class ImportDbsnpJsonVariantsJobConfigurationTest {
    ...
    public void executeJobTrueForceImport() throws Exception {
        ...
        List<String> expectedSteps = Collections.singletonList(IMPORT_DBSNP_JSON_VARIANTS_STEP);
