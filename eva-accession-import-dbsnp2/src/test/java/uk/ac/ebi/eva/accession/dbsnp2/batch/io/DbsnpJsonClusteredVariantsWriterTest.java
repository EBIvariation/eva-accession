...
public class DbsnpJsonClusteredVariantsWriterTest extends MongoTestContainerHelper {
    ...
    public void writeSingleVariant() throws Exception {
        dbsnpJsonClusteredVariantsWriter.write(Chunk.of(variantEntity1));
    ...
    public void writeMultipleVariantsWithDifferentContig() throws Exception {
        ...
        dbsnpJsonClusteredVariantsWriter.write(new Chunk<>(clusteredVariantEntities));
