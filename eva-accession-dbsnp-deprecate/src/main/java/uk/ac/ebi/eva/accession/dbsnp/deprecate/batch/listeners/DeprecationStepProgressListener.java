 ...
 */
package uk.ac.ebi.eva.accession.dbsnp.deprecate.batch.listeners;
...
public class DeprecationStepProgressListener extends StepListenerSupport<DbsnpClusteredVariantEntity, DbsnpClusteredVariantEntity> {
    ...
    public void afterChunk(ChunkContext context) {
        ...
        logger.info("{}: RS IDs read = {}, RS IDs deprecated = {}", stepName, numTotalItemsRead, numTotalItemsWritten);
    }

    @Override
    public ExitStatus afterStep(StepExecution stepExecution) {
        logger.info("Step {} finished: RS IDs read = {}, RS IDs deprecated = {}",
