 ...
 */
package uk.ac.ebi.eva.accession.dbsnp.deprecate.configuration.batch.steps;
...
public class DeprecateClusteredVariantsStepConfiguration {
    ...
    @Autowired
    @Qualifier(BeanNames.DEPRECABLE_CLUSTERED_VARIANTS_READER)
    private ItemStreamReader<DbsnpClusteredVariantEntity> deprecableClusteredVariantsReader;

    @Autowired
    @Qualifier(BeanNames.DEPRECATION_WRITER)
    ...
    @Bean(BeanNames.DEPRECATE_CLUSTERED_VARIANTS_STEP)
    public Step deprecateClusteredVariantsStep(StepBuilderFactory stepBuilderFactory,
                                               SimpleCompletionPolicy chunkSizeCompletionPolicy) {
        TaskletStep step = stepBuilderFactory.get(BeanNames.DEPRECATE_CLUSTERED_VARIANTS_STEP)
