 ...
 */
package uk.ac.ebi.eva.accession.dbsnp.deprecate.configuration.steps;
...
public class DeprecateSubsetClusteredVariantsStepConfigurationTest {
    ...
    private void assertStepExecutesAndCompletes() {
        JobExecution jobExecution = jobLauncherTestUtils.launchStep(BeanNames.DEPRECATE_CLUSTERED_VARIANTS_STEP);
