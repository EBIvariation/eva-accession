...
def set_clustering_status(profile, private_config_xml_file, clustering_tracking_table, assembly, tax_id, release_version, status):
...
if __name__ == "__main__":
    ...
    try:
        ...
        set_clustering_status(args.profile, args.private_config_xml_file, args.clustering_tracking_table, args.assembly, args.taxonomy, args.release, args.status)
