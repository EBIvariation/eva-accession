...
def count_rs_ids_in_release_files(count_ids_script_path, assembly_accession, species_release_folder):
    ...
    with open(release_count_filename, "w") as release_count_file_handle:
        ...
        for text_release_file_category in release_text_file_categories:
            text_release_file_name = get_release_text_file_name(species_release_folder, assembly_accession,
...
@click.command()
def main(count_ids_script_path, assembly_accession, species_release_folder):
    count_rs_ids_in_release_files(count_ids_script_path, assembly_accession, species_release_folder)
