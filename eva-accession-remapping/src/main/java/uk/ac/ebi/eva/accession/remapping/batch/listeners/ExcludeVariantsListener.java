...
package uk.ac.ebi.eva.accession.remapping.batch.listeners;
...
public class ExcludeVariantsListener extends StepListenerSupport<IVariant, IVariant> {
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        logger.info("Processors filtered out {} variants (possible reason is that they were named variants)",
